...
class Visiontransformer(th.nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=512, depth=12,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, qk_scale=None, representation_size=None, features_dim=512,distilled=False,
...
y=th.rand(20,3,224,224)
out_y=model(y)
print(out_y.shape)
#model_aten=Attention()
#y=th.rand(20,196,512)
#out_aten=model_aten(y)
#print(out_aten.shape)